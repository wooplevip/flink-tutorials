...
public class StreamSQLDemo3 {
	...
	public static void main(String[] args) throws Exception {
		...
		String sql = "SELECT category, shopId, avgSellId FROM ("+
	...
	public static class MemoryUpsertSink implements UpsertStreamTableSink<Tuple3<String, Integer, Integer>> {
		...
		@Override
		public TypeInformation<Tuple3<String, Integer, Integer>> getRecordType() {
			return TypeInformation.of(new TypeHint<Tuple3<String, Integer, Integer>>(){});
		}

		@Override
		public void emitDataStream(DataStream<Tuple2<Boolean, Tuple3<String, Integer, Integer>>> dataStream) {
			consumeDataStream(dataStream);
		}

		@Override
		public DataStreamSink<?> consumeDataStream(DataStream<Tuple2<Boolean, Tuple3<String, Integer, Integer>>> dataStream) {
			return dataStream.addSink(new DataSink()).setParallelism(1);
		}

		@Override
		public TableSink<Tuple2<Boolean, Tuple3<String, Integer, Integer>>> configure(String[] fieldNames, TypeInformation<?>[] fieldTypes) {
	...
	private static class DataSink extends RichSinkFunction<Tuple2<Boolean, Tuple3<String, Integer, Integer>>>{
		...
		@Override
		public void invoke(Tuple2<Boolean, Tuple3<String, Integer, Integer>> value, Context context) throws Exception {
